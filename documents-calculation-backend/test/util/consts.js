...
export const INVALID_INVOICE =
  "Vendor 2,987654321,1000000258,1,88888888888,EUR,900";
...
// Exceptions
export const INVALID_INVOICE_EXCEPTION =
  "Invoice number 1000000258's Parent number is not available in the data you have provided.";
export const INVALID_CURRENCY_EXCEPTION =
  "You tried to enter an invalid currency - the allowed currencies currently are EUR,GBP,BGN,USD";
export const INVALID_VALUE_EXCEPTION =
  "Please provide proper values for the currencies";
export const INSUFFICIENT_CURRENCIES_EXCEPTION =
  "Please provide all currencies listed in the data file";
export const WRONG_VAT_NUMBER_EXCEPTION =
  "A customer can only have one VAT number - please make sure that is the case in your data";
